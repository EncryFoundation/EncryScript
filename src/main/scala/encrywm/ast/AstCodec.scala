...
object AstCodec {
  ...
  implicit def dTrue = dEx.bind[EXPR.True](11)
  implicit def dFalse = dEx.bind[EXPR.False](12)
  implicit def dStrEx = dEx.bind[EXPR.Str](13)
  implicit def dAttribute = dEx.bind[EXPR.Attribute](14)
  implicit def dSubscript = dEx.bind[EXPR.Subscript](15)
  implicit def dName = dEx.bind[EXPR.Name](16)
  implicit def dDictEx = dEx.bind[EXPR.Dict](17)
  implicit def dSet = dEx.bind[EXPR.ESet](18)
  implicit def dListEx = dEx.bind[EXPR.EList](19)
  implicit def dTuple = dEx.bind[EXPR.Tuple](20)
  implicit def dDecl = dEx.bind[EXPR.Decl](21)
