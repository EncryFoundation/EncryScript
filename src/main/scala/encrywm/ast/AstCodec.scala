...
object AstCodec {
  ...
  implicit def dDictEx = dEx.bind[EXPR.Dict](18)
  implicit def dSet = dEx.bind[EXPR.ESet](19)
  implicit def dListEx = dEx.bind[EXPR.EList](20)
  implicit def dTuple = dEx.bind[EXPR.Tuple](21)
  implicit def dDecl = dEx.bind[EXPR.Decl](22)
