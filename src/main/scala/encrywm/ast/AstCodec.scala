...
object AstCodec {
  ...
  implicit def dDecl = dEx.bind[EXPR.Declaration](26)
  implicit def dBpd = dEx.bind[EXPR.BranchParamDeclaration](27)
  implicit def dGc = dEx.bind[EXPR.GenericCond.type](28)
